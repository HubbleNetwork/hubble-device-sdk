...
SHELL_CMD_ARG_REGISTER(time, NULL, "Set Unix epoch time", cmd_time, 2, 0);
...
int main(void)
{
	...
	printk("Insert key and epoch time to start. Type help for more "
	       "information.\n");
	...
	err = hubble_init(unix_epoch_ms, NULL);
	if (err != 0) {
