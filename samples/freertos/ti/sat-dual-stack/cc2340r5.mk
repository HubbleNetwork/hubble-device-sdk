...
SYSCFG_FILES := $(shell $(SYSCFG_CMD_STUB) --listGeneratedFiles --listReferencedFiles --output $(BUILD_DIR) sat-dual-stack-cc23.syscfg)
...
syscfg: sat-dual-stack-cc23.syscfg $(BUILD_DIR)
...
syscfg-gui: sat-dual-stack-cc23.syscfg $(SYSCONFIG_GUI_TOOL)
