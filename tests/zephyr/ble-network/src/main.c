...
static uint64_t ble_nonce_unix_epoch_ms = 1760383551803U;
...
{
	(void)hubble_init(ble_nonce_unix_epoch_ms, ble_nonce_key);
...
static uint64_t ble_adv_unix_epoch_ms = 1760210751803U;
...
{
	(void)hubble_init(ble_adv_unix_epoch_ms, ble_adv_key);
