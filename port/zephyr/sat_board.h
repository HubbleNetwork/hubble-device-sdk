 ...
 * @file sat_board.h
 * @internal
 * @brief Hubble Network Zephyr board-specific satellite communication APIs
 */

#ifndef PORT_ZEPHYR_SAT_BOARD_H
#define PORT_ZEPHYR_SAT_BOARD_H
