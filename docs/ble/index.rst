...
Initialize the network with the current Unix epoch time before calling other Hubble
...
The API provides functions to set and update the Unix epoch time (milliseconds since
January 1, 1970, 00:00:00 UTC). The `hubble_time_set` function enables precise time
